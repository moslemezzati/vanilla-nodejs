...
handlers.accountEdit = function (data, cb) {
    ...
    getTemplateWithHeaderAndFooter('accountEdit', templateData, (err, str) => {
        if (err) {
            console.log(err);
            return cb(500, undefined, 'html');
        }
...
handlers.accountDeleted = function (data, cb) {
    ...
    getTemplateWithHeaderAndFooter('accountDeleted', templateData, (err, str) => {
        if (err) {
            console.log(err);
            return cb(500, undefined, 'html');
        }
...
handlers.checksCreate = function (data, cb) {
    ...
    getTemplateWithHeaderAndFooter('checksCreate', templateData, (err, str) => {
        if (err) {
            console.log(err);
            return cb(500, undefined, 'html');
        }
...
handlers.checksList = function (data, cb) {
    ...
    getTemplateWithHeaderAndFooter('checksList', templateData, (err, str) => {
        if (err) {
            console.log(err);
            return cb(500, undefined, 'html');
        }
...
handlers.checksEdit = function (data, cb) {
    ...
    getTemplateWithHeaderAndFooter('checksEdit', templateData, (err, str) => {
        if (err) {
            console.log(err);
            return cb(500, undefined, 'html');
        }
